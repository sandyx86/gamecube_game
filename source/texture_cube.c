...
int main(void) {
    ...
    TPL_GetTexture(&tpl, yoda, &texObj); // load tpl into a texture object
    ...
    Model the_model = buildModel(cube_vtx, cube_tx, cube_idx, cube_tx_idx, cube_idxcnt);
