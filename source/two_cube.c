...
void drawModel(Mtx v, Camera *cam) {
    ...
    //maybe make an array of draw functions that get called here
        ...
        draw_quad(0+8, 3+8, 2+8, 1+8, 0); //top face
		draw_quad(0+8, 7+8, 6+8, 3+8, 1); //left face
		draw_quad(0+8, 1+8, 4+8, 7+8, 2); //back face
		draw_quad(1+8, 2+8, 5+8, 4+8, 3); //right face
		draw_quad(2+8, 3+8, 6+8, 5+8, 4); //front face
		draw_quad(4+8, 7+8, 6+8, 5+8, 5); //bottom face
