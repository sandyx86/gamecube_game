...
s16 square[] __attribute__((aligned(32))) = {
    // x y z
	-30,  30,  0, 	// 0
	 30,  30,  0, 	// 1
	 30, -30,  0, 	// 2
...
u8 colors[] __attribute__((aligned(32))) = {
    	// r, g, b, a
	0,   255,   0,   0,	// 0 purple
	240,   0,   0, 255,	// 1 red
...
void draw_vert(unsigned char pos, unsigned char c, float s, float t);
void draw_square(Mtx v);
static void copy_to_xfb(unsigned int count);
...
int main(void) {
    ...
    guPerspective(perspective, 60, 1.33F, 10.0F, 1000.0F);
	...
	TPL_OpenTPLFromMemory(&sprite, (void *)textures_tpl,textures_tpl_size);
    //TPL_OpenTPLFromFile(&sprite, "bmp/bmp_adv.tpl");
	TPL_GetTexture(&sprite,0,&texObj);
